 ...
 *
 * Every notification Skylink Bingwa posts is rendered from one of these templates, so
 ...
 *
 * 1. Skylink Bingwa NEVER claims it delivered a bundle. The customer app does not
 ...
 *    not Skylink Bingwa, is the factual source. For every other category the app must
