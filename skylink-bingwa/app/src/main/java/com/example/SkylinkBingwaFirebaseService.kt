...
/**
 * Firebase Cloud Messaging service for Skylink Bingwa.
 *
 ...
 */
class SkylinkBingwaFirebaseService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        val app = applicationContext as? SkylinkBingwaApplication
    ...
    companion object {
        private const val TAG = "SkylinkBingwaFCM"
    }
}
